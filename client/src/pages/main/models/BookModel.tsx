...
export class Convert {
  public static toBookModel(json: string): BookModel[] {
    return cast(JSON.parse(json), a(r("BookModel")))
  }

  public static bookModelToJson(value: BookModel[]): string {
    return JSON.stringify(uncast(value, a(r("BookModel"))), null, 2)
  }
}
...
const typeMap: any = {
  BookModel: o(
    [
      ...
      { json: "canBorrow", js: "canBorrow", typ: true },
      { json: "whoBorrow", js: "whoBorrow", typ: "" },
    ],
    false
  ),
}
